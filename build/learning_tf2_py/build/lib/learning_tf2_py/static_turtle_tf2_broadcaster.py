...
from geometry_msgs.msg import TransformStamped #provides messaage template that is published to transformation tree
...
class StaticFramePublisher(Node):
    ...
    def make_transforms(self, transformation):
        t = TransformStamped() #object of transformStamped

        t.header.stamp = self.get_clock().now().to_msg() #stamp
        t.header.frame_id = 'world' #parent frame name
        t.child_frame_id = transformation[1] #child frame name
# populate the 6D pose of the turtle
